...
#ifndef _TAO_IDL_MESSENGERC_AJPS8G_H_
#define _TAO_IDL_MESSENGERC_AJPS8G_H_
...
namespace Messenger
{
  ...
  struct messenger_idl_test_Export Message
  {
...
messenger_idl_test_Export ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Messenger::Message &);
messenger_idl_test_Export ::CORBA::Boolean operator>> (TAO_InputCDR &, Messenger::Message &);
